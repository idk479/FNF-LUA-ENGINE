...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("LUA", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("LUA", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "LUA";
		app.meta["name"] = "Friday Night Funkin': LUA Engine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': LUA Engine",
			width: 1280,
			x: null,
			y: null,
		};
